...
public class RenderTimeChicken extends RenderLiving {
     ...
     */
    public void doRender(TimeChicken p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(TimeChicken p_110775_1_)
    {
     ...
     */
    protected float handleRotationFloat(TimeChicken p_77044_1_, float p_77044_2_)
    {
    ...
    {
        this.doRender((TimeChicken)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        return this.handleRotationFloat((TimeChicken)p_77044_1_, p_77044_2_);
    }
    ...
    {
        return this.getEntityTexture((TimeChicken)p_110775_1_);
    }
